...
sh 'sudo scp -i ./terraform_files/DEMOKEY.pem medicure-deployment.yml ubuntu@:54.160.117.9:/home/ubuntu/'
sh 'sudo scp -i ./terraform_files/DEMOKEY.pem medicure-service.yml ubuntu@:54.160.117.9:/home/ubuntu/'
